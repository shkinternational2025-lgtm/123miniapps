...
PAGES.append(tool(
 ...
 placeholder="A concise summary of the page, around 155 characters.">101 free online tools for text, images, developers and designers. Everything runs in your browser, no uploads, no accounts, no tracking.</textarea>
 </div>"""),
 row(

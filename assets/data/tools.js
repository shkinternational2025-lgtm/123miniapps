...
const RAW_TOOLS = [
 ...
 { id: 107, name: 'Bold Text Generator', category: 'text', icon: '🅱️', premium: true, rating: 4.8, usageCount: 138000,
 description: 'Turn text into bold Unicode for LinkedIn, Instagram and boxes with no bold button.',
 features: ['Several bold Unicode styles', 'Bold serif, sans, italic, script', 'Pastes where there is no bold button', 'Click to copy'],
 keywords: ['bold text generator', 'bold text', 'linkedin bold text', 'instagram bold font', 'bold unicode', 'facebook bold text'] },
 { id: 108, name: 'Strikethrough Text Generator', category: 'text', icon: '🚫', premium: true, rating: 4.7, usageCount: 84000,
 description: 'Cross out text with real strikethrough characters that paste anywhere.',
 features: ['Long, short and slash strikethrough', 'Real combining characters', 'Pastes into chat and posts', 'Click to copy'],
 keywords: ['strikethrough text generator', 'strikethrough text', 'cross out text', 'crossed out text', 'strikethrough font'] },
 { id: 109, name: 'Small Text Generator', category: 'text', icon: '🔡', premium: true, rating: 4.6, usageCount: 71000,
 description: 'Make tiny superscript, small-caps and subscript text you can paste anywhere.',
 features: ['Superscript, small caps, subscript', 'Real Unicode tiny letters', 'For bios and usernames', 'Click to copy'],
 keywords: ['small text generator', 'tiny text', 'small caps generator', 'superscript generator', 'subscript text'] },
 { id: 110, name: 'Bionic Reading Converter', category: 'text', icon: '⚡', premium: true, rating: 4.6, usageCount: 46000,
 description: 'Bold the first part of each word to guide your eyes and read faster.',
 features: ['Bolds each word opening', 'Adjustable fixation', 'Live preview', 'Copies bold Unicode'],
 keywords: ['bionic reading', 'bionic reading converter', 'speed reading text', 'bold first letters', 'read faster'] },
 { id: 111, name: 'Word Repeater', category: 'text', icon: '🔁', premium: true, rating: 4.6, usageCount: 34000,
 description: 'Repeat a word or phrase any number of times with your chosen separator.',
 features: ['Repeat text N times', 'Space, line, comma or custom separator', 'Optional numbering', 'Copy the result'],
 keywords: ['word repeater', 'repeat text', 'repeat word generator', 'text repeater', 'duplicate text'] },
 { id: 112, name: 'YAML to JSON Converter', category: 'developer', icon: '🔄', premium: true, rating: 4.7, usageCount: 52000,
 description: 'Convert YAML to JSON and JSON back to YAML, right in your browser.',
 features: ['YAML to JSON and JSON to YAML', 'Handles nested maps and lists', 'Clear parse error messages', 'One-click copy'],
 keywords: ['yaml to json', 'json to yaml', 'yaml converter', 'yaml parser', 'convert yaml', 'yaml json'] },
 { id: 113, name: 'HTML to Markdown Converter', category: 'developer', icon: '📝', premium: true, rating: 4.7, usageCount: 61000,
 description: 'Convert HTML to clean Markdown, or Markdown back to HTML, instantly.',
 features: ['HTML to Markdown and back', 'Headings, links, lists and tables', 'Code blocks and blockquotes', 'One-click copy'],
 keywords: ['html to markdown', 'markdown to html', 'html markdown converter', 'convert html to markdown', 'markdown converter'] },
 { id: 114, name: 'PX to REM Converter', category: 'design', icon: '📐', premium: true, rating: 4.6, usageCount: 48000,
 description: 'Convert px to rem and em with any root font size, two ways.',
 features: ['px to rem and em', 'rem or em back to px', 'Any root font size', 'Reference table'],
 keywords: ['px to rem', 'rem to px', 'px to em', 'pixel to rem converter', 'rem calculator', 'css units'] },
 { id: 115, name: 'Calorie Calculator', category: 'calculator', icon: '🍎', premium: true, rating: 4.7, usageCount: 96000,
 description: 'Estimate daily calories from BMR and activity, with targets and macros.',
 features: ['BMR and TDEE estimate', 'Lose, maintain or gain targets', 'Protein, carb and fat split', 'Metric or imperial'],
 keywords: ['calorie calculator', 'bmr calculator', 'tdee calculator', 'daily calorie needs', 'maintenance calories', 'macro calculator'] },
